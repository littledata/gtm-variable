...

{
  ...
  "description": "Returns values from the data layer generated by the Littledata Shopify App. This Shopify product and customer information from the Shopify store can be sent to third party trackers (Instagram, Facebook, Pinterest, etc.)",
  "containerContexts": [
    "WEB"
  ],
